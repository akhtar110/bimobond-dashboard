...
class _SearchHistoryPaginationBar extends StatelessWidget {
  const _SearchHistoryPaginationBar({
    required this.page,
  ...
  Widget build(BuildContext context) {
    ...
    final m = metrics ??
        SearchHistoryLayoutMetrics(
          getSearchHistoryDeviceType(MediaQuery.sizeOf(context).width),
        );
