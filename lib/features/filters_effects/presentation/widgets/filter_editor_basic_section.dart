        ...
        children: [
          ...
          FeEditorSyncedTextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: l10n.tOr('feCustomLabelHint', 'Optional localized override'),
              errorText: _fieldError(context, 'customLabel'),
            ),
            onChanged: (value) => bloc.add(
          ...
          FeEditorSyncedTextField(
            ...
            decoration: InputDecoration(
              ...
              errorText: _fieldError(context, 'sortOrder'),
            ),
            onChanged: (value) => bloc.add(
              FilterBasicFieldChanged(
          ...
          if (form.isOriginal || form.isBeautyDefault) ...[
              ...
              children: [
                if (form.isOriginal)
                  Chip(
                    ...
                    label: Text(l10n.tOr('feOriginalBadge', 'Original (Read-Only)')),
                    backgroundColor: scheme.secondaryContainer,
                    labelStyle: TextStyle(color: scheme.onSecondaryContainer, fontSize: 12),
                  ),
                if (form.isBeautyDefault)
                  Chip(
                    avatar: const Icon(Icons.face_rounded, size: 16),
                    label: Text(l10n.tOr('feBeautyDefaultBadge', 'Beauty Default (Read-Only)')),
                    backgroundColor: scheme.tertiaryContainer,
                    labelStyle: TextStyle(color: scheme.onTertiaryContainer, fontSize: 12),
                  ),
              ],
            ),
          ],
