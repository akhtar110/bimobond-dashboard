...
class UserModel extends UserEntity {
  ...
  factory UserModel.fromEntity(UserEntity user) {
    ...
    return UserModel(
      ...
      likedVideosVisibility: user.likedVideosVisibility,
      followersListVisibility: user.followersListVisibility,
      followingListVisibility: user.followingListVisibility,
      discoverable: user.discoverable,
      suggestToContacts: user.suggestToContacts,
      profileViewHistoryEnabled: user.profileViewHistoryEnabled,
      showActivityStatus: user.showActivityStatus,
      restrictedMode: user.restrictedMode,
      showShopOnProfile: user.showShopOnProfile,
      allowDuetsDefault: user.allowDuetsDefault,
      allowStitchDefault: user.allowStitchDefault,
      allowDownloadsDefault: user.allowDownloadsDefault,
      allowRepostsDefault: user.allowRepostsDefault,
      showRepostsOnProfile: user.showRepostsOnProfile,
      ...
      isOnlineOverride: user.isOnlineOverride,
      roles: user.roles,
      wallet: user.wallet,
      relationCounts: user.relationCounts,
