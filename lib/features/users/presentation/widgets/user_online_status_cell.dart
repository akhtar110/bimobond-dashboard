...
class _UserOnlineStatusCellState extends State<UserOnlineStatusCell> {
  ...
  Widget build(BuildContext context) {
    ...
    final dotColor = isOnline ? const Color(0xFF22C55E) : scheme.onSurfaceVariant.withValues(alpha: 0.4);
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: isOnline ? const Color(0xFF16A34A) : scheme.onSurfaceVariant,
              ),
            ),
          ],
        ),
